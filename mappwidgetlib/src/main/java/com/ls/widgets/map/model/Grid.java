...
public class Grid {
    ...
    private OnGridReadyListener onReadyListener;  // Grid加载完成监听器

    //View where drawing will be occurred
    private View parentView;

    //Model of the grid. Grid是由一个个cell单位组成的
...
//		
    ...
    public double getScale() {
        ...
        return (1.0 / (Math.pow(OfflineMapUtil.getScalepProp(), maxZoomLevel - zoomLevel))) * scale;
    }
